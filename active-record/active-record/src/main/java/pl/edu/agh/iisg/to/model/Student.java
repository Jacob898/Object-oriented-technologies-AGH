...
public class Student {
    ...
    public static Optional<Student> findByIndexNumber(final int indexNumber) {
        // TODO - drugi sposób - sprawdź find
    ...
    public Map<Course, Float> createReport() {
        String getAvgGradesSql = "SELECT c.id as id, c.name as name, AVG(g.grade) as avg_grade " +
                "FROM course c " +
        ...
        try (ResultSet rs = QueryExecutor.read(getAvgGradesSql, args)) {
            while (rs.next()) {
