            ...
            try {
                ...
                for (String photoUrl : photoUrls) {
                    try {
                        ...
                        log.log(Level.WARNING, "Could not download photo from URL: " + photoUrl, e);
                    }
                }
                observer.onComplete();
            } catch (IOException e) {
                observer.onError(new IOException("Error during searching photos for query: " + searchQuery, e));
            }
        });
    }
