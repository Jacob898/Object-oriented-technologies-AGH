...
//        SerializablePersistenceManager persistenceManager = new SerializablePersistenceManager();
//        persistenceManager.setClassStorageFileName("classes2.dat");
//        school = new School(new SchoolDAO(persistenceManager));
    }
...
//                new FileMessageSerializer("persistence.log"));
